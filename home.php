      ...
      <div class="pc-container">
        ...
        <nav class="pc-nav">
          <ul class="pc-nav-list">
            ...
            <li class="pc-nav-item">
              <a class="pc-nav-link reserve-btn" href=" <?php echo esc_url( home_url('/recruit')); ?>"><span>採用情報</span></a>
            </li>
          </ul>
        </nav>
      </div>
      ...
      <section id="menu" class="p-menu">
        <div class="c-container">
          <div class="p-menu__block  appear up">
            ...
            <a href=" <?php echo esc_url( home_url('/about')); ?>" class="p-menu__btn third item">
              <div class="p-menu__btn-inner">
                <div class="p-menu__btn-inner-text menu-btn01">
                  <div class="p-menu__btn-title">
              ...
              <img src="<?php echo get_template_directory_uri(); ?>/images/home/whitenig__2.jpg" class="item" />
            </a>
          </div>
        </div>
      </section>
        ...
        <div class="p-footer__inner">
          ...
          <div class="p-footer__block02">
            <ul class="p-footer__nav">
              ...
              <li class="gnav06"><a class="c-txt-sm" href=" <?php echo esc_url( home_url('/recruit')); ?>">採用情報</a></li>
            </ul>
    ...
    <div class="mobile-menu">
      <nav class="mobile-menu__nav">
        <ul class="mobile-menu__list">
          ...
          <li class="mobile-menu__item"><a href="<?php echo esc_url( home_url('/expense')); ?>">自費治療について</a></li>
